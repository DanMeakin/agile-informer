...
var _DanMeakin$agile_informer$Model$makeAvatar = F2(
	function (gender, num) {
		return A2(
			...
			{gender: gender, num: num}) : _elm_lang$core$Maybe$Nothing;
	});
var _DanMeakin$agile_informer$Model$isFocussed = F2(
	function (project, strategy) {
		var _p0 = project.plan.focusedStrategy;
		if (_p0.ctor === 'Nothing') {
			return false;
		} else {
...
var _DanMeakin$agile_informer$Model$Project = F9(
...
var _DanMeakin$agile_informer$Model$Strategy = F2(
	function (a, b) {
...
var _DanMeakin$agile_informer$Model$Avatar = F2(
	function (a, b) {
		return {gender: a, num: b};
	});
var _DanMeakin$agile_informer$Model$CloseMailbox = {ctor: 'CloseMailbox'};
var _DanMeakin$agile_informer$Model$ShowMailbox = {ctor: 'ShowMailbox'};
var _DanMeakin$agile_informer$Model$UnfocusStrategy = {ctor: 'UnfocusStrategy'};
var _DanMeakin$agile_informer$Model$FocusStrategy = function (a) {
	return {ctor: 'FocusStrategy', _0: a};
};
var _DanMeakin$agile_informer$Model$UpdateDate = function (a) {
	return {ctor: 'UpdateDate', _0: a};
};
var _DanMeakin$agile_informer$Model$UnfocusProject = {ctor: 'UnfocusProject'};
var _DanMeakin$agile_informer$Model$FocusProject = function (a) {
	return {ctor: 'FocusProject', _0: a};
};
var _DanMeakin$agile_informer$Model$Mailbox = {ctor: 'Mailbox'};
var _DanMeakin$agile_informer$Model$Tactics = {ctor: 'Tactics'};
var _DanMeakin$agile_informer$Model$Symphony = {ctor: 'Symphony'};
var _DanMeakin$agile_informer$Model$Swirls = {ctor: 'Swirls'};
var _DanMeakin$agile_informer$Model$Seigaiha = {ctor: 'Seigaiha'};
var _DanMeakin$agile_informer$Model$NaturalWhite = {ctor: 'NaturalWhite'};
var _DanMeakin$agile_informer$Model$Cork = {ctor: 'Cork'};
var _DanMeakin$agile_informer$Model$PendingReports = {ctor: 'PendingReports'};
var _DanMeakin$agile_informer$Model$Activity = function (a) {
	return {ctor: 'Activity', _0: a};
};
var _DanMeakin$agile_informer$Model$Concluded = {ctor: 'Concluded'};
var _DanMeakin$agile_informer$Model$Inactive = {ctor: 'Inactive'};
...
var _DanMeakin$agile_informer$View$avatarClass = function (av) {
	...
	var classFromAv = A2(
		_elm_lang$core$Basics_ops['++'],
		genderPrefix,
		_elm_lang$core$Basics$toString(av.num));
	return _elm_lang$html$Html_Attributes$class(
		A2(_elm_lang$core$Basics_ops['++'], 'float-right avatar ', classFromAv));
};
var _DanMeakin$agile_informer$View$avatar = function (av) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _DanMeakin$agile_informer$View$avatarClass(av),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _DanMeakin$agile_informer$View$statusLabel = function (status) {
	var _p1 = status;
	if (_p1.ctor === 'PendingReports') {
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('label warning'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Pending Reports'),
				_1: {ctor: '[]'}
			});
	} else {
		switch (_p1._0.ctor) {
			case 'Active':
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('label success'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
			...
			default:
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Concluded'),
						_1: {ctor: '[]'}
					});
		}
	}
};
var _DanMeakin$agile_informer$View$cardBackgroundClass = function (background) {
	var _p2 = background;
	switch (_p2.ctor) {
		case 'Cork':
			return _elm_lang$html$Html_Attributes$class('cork');
		case 'NaturalWhite':
			return _elm_lang$html$Html_Attributes$class('natural-white');
		case 'Seigaiha':
			return _elm_lang$html$Html_Attributes$class('seigaiha');
		case 'Swirls':
			return _elm_lang$html$Html_Attributes$class('swirls');
		default:
			return _elm_lang$html$Html_Attributes$class('symphony');
	}
};
var _DanMeakin$agile_informer$View$projectCard = function (project) {
	var bg = _DanMeakin$agile_informer$View$cardBackgroundClass(project.background);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _DanMeakin$agile_informer$View$avatarClass(project.avatar),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(project.shortDescription),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _DanMeakin$agile_informer$View$allCards = function (model) {
	var mkCard = function (cd) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('small-12 medium-6 columns'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _DanMeakin$agile_informer$View$projectCard(cd),
				_1: {ctor: '[]'}
			});
	};
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('project-cards'),
			_1: {
				ctor: '::',
		...
		A2(_elm_lang$core$List$map, mkCard, model.projects));
};
var _DanMeakin$agile_informer$View$showDate = function (date) {
	return A2(
		_elm_lang$core$String$join,
		' ',
		{
...
var _DanMeakin$agile_informer$View$mailboxView = F2(
	function (today, project) {
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('button tiny'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$title('Create Tactic'),
								_1: {ctor: '[]'}
							}
						}
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('fi-plus'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$title('Attach to Existing'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('fi-paperclip'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('button tiny warning'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$title('Note & Archive'),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fi-archive'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('button tiny alert'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$title('Close Issue'),
											_1: {ctor: '[]'}
										}
									}
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('fi-x'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
		...
		var mailMessage = function (msg) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('small-12 columns card'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('small-4 columns'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(msg.sender),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('small-8 columns'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text(msg.heading),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
										_1: {
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('row columns align-right'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
	...
	function (today, project) {
		...
		var tacticCard = function (t) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('card tactic'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('card-divider heading'),
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(t.description),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Acceptance: '),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(t.acceptanceCriteria),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
		...
		var tacticColumn = F2(
			function (heading, tactics) {
				return A2(
					_elm_lang$html$Html$div,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('tactic-column'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('tactic-header'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: A2(_elm_lang$core$List$map, tacticCard, tactics)
					});
			});
		...
		var tacticsOngoing = A2(_elm_lang$core$List$filter, futureCompletionDate, allTactics);
		var tacticsAwaitingAssessment = A2(_elm_lang$core$List$filter, awaitingAssessment, allTactics);
		var tacticsComplete = A2(_elm_lang$core$List$filter, complete, allTactics);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('row tactics-columns'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('small-3 columns'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(tacticColumn, 'Todo', tacticsNoDate),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(tacticColumn, 'Ongoing', tacticsOngoing),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(tacticColumn, 'Complete', tacticsComplete),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _DanMeakin$agile_informer$View$projectInner = F2(
	function (today, project) {
		var _p9 = project.showView;
		if (_p9.ctor === 'Tactics') {
			return A2(_DanMeakin$agile_informer$View$tacticsView, today, project);
		} else {
			return A2(_DanMeakin$agile_informer$View$mailboxView, today, project);
		}
	});
var _DanMeakin$agile_informer$View$sidebar = function (project) {
	var navLink = function () {
		var _p10 = project.showView;
		if (_p10.ctor === 'Mailbox') {
			return A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('hollow button yellow'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_DanMeakin$agile_informer$Model$CloseMailbox),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Close Mailbox'),
					_1: {ctor: '[]'}
				});
		} else {
			return A2(
				_elm_lang$html$Html$button,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_DanMeakin$agile_informer$Model$ShowMailbox),
							_1: {ctor: '[]'}
						}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('badge yellow'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: function (_p11) {
								...
								_elm_lang$core$List$length(project.mailbox)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
	...
	var stratAttrs = function (strategy) {
		return A2(_DanMeakin$agile_informer$Model$isFocussed, project, strategy) ? {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('strategy focused-strategy'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_DanMeakin$agile_informer$Model$UnfocusStrategy),
				_1: {ctor: '[]'}
			}
		} : {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('strategy'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_DanMeakin$agile_informer$Model$FocusStrategy(strategy)),
				_1: {ctor: '[]'}
			}
		};
	};
	var mkStrategy = function (strategy) {
		return A2(
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('strategy-text'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(strategy.description),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_DanMeakin$agile_informer$Model$UnfocusProject),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('small-12 medium-2 columns'),
							_1: {ctor: '[]'}
						}
					},
					{
						ctor: '::',
						_0: _DanMeakin$agile_informer$View$sidebar(project),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(_DanMeakin$agile_informer$View$projectInner, today, project),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _DanMeakin$agile_informer$View$landingBody = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _DanMeakin$agile_informer$View$allCards(model),
			_1: {ctor: '[]'}
		});
};
...
var _DanMeakin$agile_informer$Update$update = F2(
			...
			case 'FocusProject':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							focusedProject: _elm_lang$core$Maybe$Just(_p0._0)
						}),
					{ctor: '[]'});
			case 'UnfocusProject':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{focusedProject: _elm_lang$core$Maybe$Nothing}),
					{ctor: '[]'});
			case 'UpdateDate':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							currentDate: _elm_lang$core$Date$fromTime(_p0._0)
						}),
					{ctor: '[]'});
			case 'FocusStrategy':
				var project = model.focusedProject;
				var _p1 = project;
				if (_p1.ctor === 'Nothing') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
					...
					var _p2 = _p1._0;
					var plan = _p2.plan;
					var plan_ = _elm_lang$core$Native_Utils.update(
						plan,
						{
							focusedStrategy: _elm_lang$core$Maybe$Just(_p0._0)
						});
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								focusedProject: _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										_p2,
										{plan: plan_}))
							}),
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								focusedProject: _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										_p5._0,
										{showView: _DanMeakin$agile_informer$Model$Mailbox}))
							}),
						{ctor: '[]'});
				}
			default:
...
var _DanMeakin$agile_informer$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _DanMeakin$agile_informer$Model$UpdateDate);
};
...
var _DanMeakin$agile_informer$Main$main = _elm_lang$html$Html$program(
	{init: _DanMeakin$agile_informer$Main$init, update: _DanMeakin$agile_informer$Update$update, view: _DanMeakin$agile_informer$View$view, subscriptions: _DanMeakin$agile_informer$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _DanMeakin$agile_informer$Main$main !== 'undefined') {
    _DanMeakin$agile_informer$Main$main(Elm['Main'], 'Main', undefined);
}
